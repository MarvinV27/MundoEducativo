...
const image1 = require('../../../assets/img/Resta1.png');
const image2 = require('../../../assets/img/Resta2.png');

const videos = [
  { id: "42vjqtleG9E", title: "Aprendiendo a restar" },
...
const L1mate = () => {
    ...
    if (user) {
      try {
        ...
        if (!userQuerySnapshot.empty) {
          ...
          if (userData.progreso && userData.progreso.matematica && userData.progreso.matematica.leccionesCompletadasL4) {
            ...
            await userDoc.update({
              ...
              'progreso.matematica.leccionesCompletadasL4': true // Marcar la lección como completada
            });
            Alert.alert(
              'Éxito',
              ...
              [
                { text: 'OK' },
                { text: 'Regresar a Materias', onPress: () => navigation.navigate('HomeScreen') }
              ]
            );
          }
        } else {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>Restas Básicas</Text>
      
      <View style={styles.textBox}>
        <Text style={styles.text}> ¿Qué es una resta?</Text>
        <Text style={styles.text1}>Una resta es una forma de quitar cosas de un grupo. Usamos la resta para saber cuántas cosas quedan cuando quitamos algunas.</Text>
      </View>
    
      <View style={styles.textBox}>
        <Text style={styles.text}>Ejemplo de resta</Text>
        <Text style={styles.text1}>Por ejemplo: si tienes 2 manzana y le quitas 1 manzana, tendrás un total de 1 manzana</Text>
        <Image source={image1} style={styles.image} />
      </View>

      <View style={styles.textBox}>
        <Text style={styles.text}>Ejemplo de resta</Text>
        <Text style={styles.text1}>Por ejemplo: si tienes 5 manzanas y le quitas  2 manzanas, tendrás un total de 3 manzanas.</Text>
