...
const image1 = require('../../../assets/img/escribir.png');

const videos = [
  { id: "m2rNL3Z56PE", title: "Aprende a escribir a números del 1 al 20" },
...
const L1mate = () => {
    ...
    if (user) {
      try {
        ...
        if (!userQuerySnapshot.empty) {
          ...
          if (userData.progreso && userData.progreso.matematica && userData.progreso.matematica.leccionesCompletadasL2) {
            ...
            await userDoc.update({
              ...
              'progreso.matematica.leccionesCompletadasL2': true // Marcar la lección como completada
            });
            Alert.alert(
              'Éxito',
              ...
              [
                { text: 'OK' },
                { text: 'Siguiente Lección 3', onPress: () => navigation.navigate('L3mate') }
              ]
            );
          }
        } else {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>Escribir los números del 1 al 20</Text>
      ...
      <View style={styles.textBox}>
        <Text style={styles.text}>Formación de los números:</Text>
        <Text style={styles.text1}>Los números tienen una forma específica que podemos seguir para escribirlos correctamente.</Text>
      </View>
