...
const image1 = require('../../../assets/img/PELOTA.png');
const image2 = require('../../../assets/img/A.png');
const image3 = require('../../../assets/img/E.png');
const image4 = require('../../../assets/img/I.png');
const image5 = require('../../../assets/img/O.png');
const image6 = require('../../../assets/img/U.png');

const videos = [
  { id: "ccK3YZjInME", title: "Las Sílabas" },
...
const L1lenguaje = () => {
    ...
    if (user) {
      try {
        ...
        if (!userQuerySnapshot.empty) {
          ...
          if (userData.progreso && userData.progreso.lenguaje && userData.progreso.lenguaje.leccionesCompletadasL3) {
            ...
            await userDoc.update({
              ...
              'progreso.lenguaje.leccionesCompletadasL3': true // Marcar la lección como completada
            });
            Alert.alert(
              'Éxito',
              ...
              [
                { text: 'OK' },
                { text: 'Siguiente Lección 4', onPress: () => navigation.navigate('L4lenguaje') }
              ]
            );
          }
        } else {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>Las Sílabas</Text>
      ...
      <View style={styles.textBox}>
        <Text style={styles.text}>¿Qué son las Sílabas?</Text>
        <Text style={styles.text1}>
        Las sílabas son las unidades de sonido que forman una palabra. Cada palabra se puede dividir en partes más pequeñas, y esas partes son las sílabas.</Text>
        <Image source={image1} style={styles.image} />
        <Text style={styles.text1}>"Pe", "lo" y "ta" son las sílabas de la palabra "pelota". Cada sílaba tiene al menos una vocal (a, e, i, o, u), y las consonantes acompañan a las vocales para formar una sílaba.
        </Text>
      </View>
