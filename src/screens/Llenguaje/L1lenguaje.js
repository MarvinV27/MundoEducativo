...
const image1 = require('../../../assets/img/Vocales.png');
...
const videos = [
  { id: "FwoulzCrwDM", title: "Las Vocales" },
    ...
    if (user) {
      try {
        ...
        if (!userQuerySnapshot.empty) {
          ...
          if (userData.progreso && userData.progreso.lenguaje && userData.progreso.lenguaje.leccionesCompletadasL1) {
            ...
            await userDoc.update({
              ...
              'progreso.lenguaje.leccionesCompletadasL1': true // Marcar la lección como completada
            });
            Alert.alert(
              'Éxito',
              ...
              [
                { text: 'OK' },
                { text: 'Siguiente Lección 2', onPress: () => navigation.navigate('L2lenguaje') }
              ]
            );
          }
        } else {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.textBox}>
        <Text style={styles.text}>¿Qué son las vocales?</Text>
        <Text style={styles.text1}>
        Las vocales son un conjunto de cinco letras del alfabeto que tienen un sonido propio y son esenciales en la formación de palabras. En el idioma español</Text>
        </View>

      <View style={styles.textBox}>
        <Text style={styles.text}>las vocales son</Text>
      </View> 
